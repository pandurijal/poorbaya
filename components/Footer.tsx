...
export const Footer: React.FC = () => {
  return (
    <footer className="py-12 px-6 md:px-12 bg-paper border-t border-border">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-end md:items-center gap-6">
        <div>
          ...
          <MonoText className="text-xs text-stone-400">
            © 2025 Poorbaya Ledger Systems.<br/>
            All rights reserved.
          </MonoText>
        </div>
      ...
      <div className="max-w-5xl mx-auto mt-8 pt-6 border-t border-stone-100 text-center">
        <MonoText className="text-xs text-stone-500">
          built by <a href="https://vibecoding.id" target="_blank" rel="noopener noreferrer" className="text-ink hover:underline" data-umami-event="click-vibecoding">vibecoding.id</a>
          {' · '}
          <a href="https://s.id/afpchannel" target="_blank" rel="noopener noreferrer" className="text-ink hover:underline" data-umami-event="click-afpchannel">belajar vibecoding bareng di s.id/afpchannel</a>
        </MonoText>
      </div>
    </footer>
  );
